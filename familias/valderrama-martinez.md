# Familia Valderrama–Martínez

## Núcleo familiar

Esta rama corresponde a los hijos de **Mario Gerardo Valderrama Mutis** y **Zilia Margarita Martínez Cabrales**, y permite continuar el árbol desde la generación de los abuelos paternos hacia **Gabriel José Valderrama Martínez** y sus hermanos.

La información de esta sección procede por ahora de **memoria familiar directa (nivel C)** y debe corroborarse progresivamente con registros civiles, matrimoniales, obituarios y otras fuentes primarias.

> **Regla de identidad:** no confundir a **Mario Gerardo Valderrama Mutis** (padre de la fratría) con su hijo homónimo **Mario Gerardo Valderrama Martínez**.

---

## Fratría Valderrama Martínez

### 1. Mario Gerardo Valderrama Martínez
...
La familia informa que tuvo **varios hijos**. Hasta ahora se conocen nominalmente:

- **Zilia Valderrama [segundo apellido desconocido]**.
- **Sebastián Valderrama [segundo apellido desconocido]**.
- **Otros hijos cuya existencia es conocida por la familia, pero cuyas identidades permanecen pendientes de reconstrucción**.

Estado: **C — memoria familiar directa**.

No debe asignarse segundo apellido, madre, fecha de nacimiento ni otros datos a Zilia o Sebastián hasta encontrar una fuente o recibir información familiar adicional.

### Preguntas abiertas

1. ¿Cuál fue la fecha completa de nacimiento de Mario Gerardo Valderrama Martínez?
2. ¿En qué fecha y lugar falleció?
3. ¿Quién fue o quiénes fueron las madres de sus hijos?
4. ¿Cuáles son los nombres completos de Zilia y Sebastián?
5. ¿Quiénes son los demás hijos conocidos por la familia?
6. ¿Existen obituarios, registros civiles, notas sociales o documentos sucesorales que permitan reconstruir su descendencia completa?

---

### 2. Gabriel José Valderrama Martínez
...
## Esquema genealógico provisional
...
| Afirmación | Estado | Evidencia actual | Documento prioritario |
|---|---|---|---|
| Mario Gerardo Valderrama Martínez nació en 1962 | C | memoria familiar | registro civil |
| Mario Gerardo Valderrama Martínez falleció | C | memoria familiar | registro civil de defunción / obituario |
| Año de fallecimiento de Mario Gerardo | E | pendiente | defunción / obituario |
| Mario Gerardo tuvo varios hijos | C | memoria familiar | registros civiles / sucesión / obituario |
...
### P0 — Mario Gerardo Valderrama Martínez

- localizar registro civil de nacimiento de 1962;
- localizar registro de defunción u obituario para fijar el año de fallecimiento;
- reconstruir su descendencia completa;
...
Conectar documentalmente esta generación con:

- **Mario Gerardo Valderrama Mutis**;
- **Zilia Margarita Martínez Cabrales**;
- las ramas **Valderrama–Mutis** y **Martínez–Cabrales** ya investigadas en el repositorio.

---

## Estado general

La estructura familiar es actualmente **C fuerte como tradición familiar**, pero todavía carece de documentación primaria suficiente para elevar los nacimientos, matrimonios, fallecimientos y filiaciones de esta generación a nivel A.