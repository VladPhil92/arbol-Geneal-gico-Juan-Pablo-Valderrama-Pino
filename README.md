...
- la posible bifurcación **Valderrama de Sopetrán/Antioquia** y su eventual conexión con la familia Valderrama Tobón;
...
El estado maestro de las investigaciones realizadas hasta el **11 de septiembre de 2026** está en:

- [`investigacion/estado-consolidado-2026-09-11.md`](investigacion/estado-consolidado-2026-09-11.md)

Este corte distingue explícitamente entre **identidad histórica**, **filiación genealógica** y **grado de parentesco**, para evitar que un personaje históricamente documentado sea incorporado automáticamente al árbol directo sin prueba filiatoria.

### Hallazgos recientes principales

- **Ricardo Valderrama** dejó de ser únicamente un nodo genealógico: existe evidencia histórica de su actividad como presidente del Concejo de Bucaramanga, actor cívico, administrador durante la Guerra de los Mil Días, funcionario y contratista del correo nacional.
- La lectura `Ricardo Valderrama O. = O’Leary` quedó debilitada por la identificación histórica separada de **Ricardo Valderrama Ordóñez**, hijo, adulto ya en 1895.
...
- [`familias/valderrama-martinez.md`](familias/valderrama-martinez.md): generación de Gabriel José, Mario Gerardo y Juan Carlos Valderrama Martínez.
- [`familias/valderrama-ordonez.md`](familias/valderrama-ordonez.md): rama Valderrama, Santander, Boyacá y Sopetrán.
- [`familias/mutis.md`](familias/mutis.md): rama Mutis de Santander y conexión colateral con José Celestino Mutis.
...
- [`investigacion/ricardo-valderrama-bucaramanga-guerra-mil-dias.md`](investigacion/ricardo-valderrama-bucaramanga-guerra-mil-dias.md)
- [`investigacion/depuracion-felix-valderrama-pineros-guevara.md`](investigacion/depuracion-felix-valderrama-pineros-guevara.md)
- [`investigacion/juan-nepomuceno-valderrama-pinzon-general-gobernador.md`](investigacion/juan-nepomuceno-valderrama-pinzon-general-gobernador.md)
- [`investigacion/domingo-soriano-valderrama-belen-cerinza.md`](investigacion/domingo-soriano-valderrama-belen-cerinza.md)
- [`investigacion/juan-jose-valderrama-la-violeta.md`](investigacion/juan-jose-valderrama-la-violeta.md)
- [`investigacion/matriz-evidencia-valderrama-1770-1930.md`](investigacion/matriz-evidencia-valderrama-1770-1930.md)
- [`investigacion/origenes-valderrama-nuevo-reino-granada.md`](investigacion/origenes-valderrama-nuevo-reino-granada.md)
- [`investigacion/red-historica-valderrama-boyaca-santander.md`](investigacion/red-historica-valderrama-boyaca-santander.md)
- [`investigacion/fase-alfonso-mena-anyel-bechara.md`](investigacion/fase-alfonso-mena-anyel-bechara.md)
- [`investigacion/hortensia-bechara-castoony_trayectoria-comercial.md`](investigacion/hortensia-bechara-castoony_trayectoria-comercial.md)
- [`investigacion/maria-del-rosario-chayo-pino-bechara.md`](investigacion/maria-del-rosario-chayo-pino-bechara.md)
- [`investigacion/linaje-mutis_generacion_por_generacion.md`](investigacion/linaje-mutis_generacion_por_generacion.md)
- [`investigacion/linaje-martinez-cabrales_generacion_por_generacion.md`](investigacion/linaje-martinez-cabrales_generacion_por_generacion.md)

### Fuentes, testimonios y textos
...
El agente está diseñado para **no reescribir por sí solo el árbol canónico**. Cada ejecución debe mantener separada la evidencia histórica de la filiación genealógica hasta que exista prueba suficiente.
...
- **María del Rosario Pino Bechara**, hija adoptiva/criada por Marco Tulio Pino Uribe y Hortensia Bechara, e hija biológica de Diana Farah Mizrahy según memoria familiar del proyecto.

## Regla editorial

Este repositorio es una investigación en curso. Ningún parentesco debe considerarse probado únicamente por coincidencia de apellidos, proximidad geográfica, memoria familiar aislada o árboles digitales sin documentación. La meta es sustituir progresivamente las afirmaciones de niveles C–E por documentación primaria de nivel A siempre que sea posible.
